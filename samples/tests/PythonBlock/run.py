...
class PySysTest(AnalyticsBuilderBaseTest):
	def execute(self):
		self.correlator = self.startAnalyticsBuilderCorrelator(blockSourceDir=f'{self.project.SOURCE}/blocks/', config=f"{self.project.SOURCE}/plugins/Python/plugin.yaml")
