...
Blocks are implemented in Apama's Event Processing Language (EPL). This guide assumes a working knowledge of EPL. Refer to the [Apama documentation on developing EPL applications](https://cumulocity.com/apama/docs/2026/developing-apama-applications-in-epl/getting-started-with-apama-epl/) and the [API Reference for EPL (ApamaDoc)](https://cumulocity.com/apama/docs/2026/related/ApamaDoc/index.html). This guide also assumes a working knowledge of the Analytics Builder data model. Refer to the [Streaming Analytics guide](https://cumulocity.com/docs/2026/streaming-analytics/analytics-builder/#getting-started).
